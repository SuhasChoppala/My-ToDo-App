            ...
            <div class={`${filteredTodo.bgColor} ${filteredTodo.isCompleted ? 'opacity-20' : ''} h-52 border-2 border-transparent hover:border-black rounded-lg shadow-lg p-3.5 transition duration-300 transform hover:scale-105`}>
                ...
                <div className='flex justify-between items-center'>
                    <div class="flex items-center gap-3">
                        <button className='relative border border-black p-2 rounded-full transition-transform transform hover:scale-110 hover:bg-black hover:border-transparent hover:shadow-lg flex items-center justify-center group lg:p-1.5 xl:p-2'>
                            <Image
                        ...
                        <button
                            onClick={removeTodo}
                            className='relative border border-black p-2 rounded-full transition-transform transform hover:scale-110 hover:bg-black hover:border-transparent hover:shadow-lg flex items-center justify-center group lg:p-1.5 xl:p-2'>
                            <Image
                                src="/delete-icon.png"
                                alt="delete"
                                width={20}
